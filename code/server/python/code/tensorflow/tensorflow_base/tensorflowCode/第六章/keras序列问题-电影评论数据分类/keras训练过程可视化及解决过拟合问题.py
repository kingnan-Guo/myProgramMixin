...
# Description:  
#    # 添加 Dropout
#    用 GlobalAveragePooling2D 替换   Flatten => （none， 50）， 将 300 取平均数 变为一维
#
#-------------------------------------------------------------------------------
...
history = model.fit(x_train_300, y_train, epochs=5, batch_size=256, validation_data=(x_test_300, y_test))
